...
def eval_single_process(cfg: DictConfig):
    ...
    from libero_plus_eval_utils import build_suite
    ...
    if str(cfg.EVALUATION.task_suite_name) == "libero_mix" and cat is None:
        raise ValueError("EVALUATION.category_value must be set for task_suite_name=libero_mix.")
    task_suite = build_suite(str(cfg.EVALUATION.task_suite_name), category_value=cat)
