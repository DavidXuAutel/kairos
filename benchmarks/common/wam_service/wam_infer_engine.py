...
class WamInferEngine:
    def __init__(self, cfg_path: str, device: Optional[str] = None):
        ...
        _ensure_dist_init()
        # WAM configs execute runtime environment lookups and are not lazy
        # import configs. Be explicit because MMEngine misclassifies stdlib
        # imports when Python runs from a system-site-packages venv.
        cfg = Config.fromfile(self.cfg_path, lazy_import=False)
